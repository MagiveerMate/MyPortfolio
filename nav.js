document.addEventListener("DOMContentLoaded", function () {
    var navbarIcon = document.getElementById("navbar_icon");
    var navbar = document.querySelector(".navbar");
    var content = document.querySelector(".content");
    var body = document.querySelector("body");
  
    navbarIcon.addEventListener("click", function () {
      var navbarLeft = parseInt(getComputedStyle(navbar).getPropertyValue("left").match(/-?\d+/)[0], 10);
  
      if (navbarLeft < 0) {
        navbar.style.left = "0px";
        navbarIcon.style.left = "0px";
        body.style.overflowX = "hidden";
        navbar.style.overflowY = "hidden";
      } else {
        navbar.style.left = "-145px";
        navbarIcon.style.left = "75px";
        if (content) {
